...
void setup() {
  ...
  for (uint8_t i = 0; i < orderedCount; ++i) {
    byte status = mlx[i].begin(ordered[i], 7, Wire);
...
void loop() {
  ...
  Serial.print(x_normalized[2]); Serial.print(",");
  Serial.print(y_normalized[2]); Serial.print(",");
  Serial.print(z_normalized[2]); Serial.print(",");
  Serial.print(x_normalized[1]); Serial.print(",");
  Serial.print(y_normalized[1]); Serial.print(",");
  Serial.print(z_normalized[1]); Serial.print(",");
  Serial.print(x_normalized[0]); Serial.print(",");
  Serial.print(y_normalized[0]); Serial.print(",");
  Serial.print(z_normalized[0]); Serial.print(",");
  Serial.print(x_normalized[3]); Serial.print(",");
  Serial.print(y_normalized[3]); Serial.print(",");
  Serial.print(z_normalized[3]); Serial.print(",");
  Serial.println();
